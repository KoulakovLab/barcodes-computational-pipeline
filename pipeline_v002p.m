%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% BeGiN 'pipeline_v002p'                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   
%   (c) Alex Koulakov (akula@cshl.edu) 2019 
%
function [ STATISTICS ] = pipeline_v002p( ConnMat,CORA,CORD,Cj,ClstrC,uC1clstrmp , OUTPUT )
%%
% Input Variables
  C1 = ConnMat;
  CORA1 = CORA;
...
%  urA11clm  = tturA11clm';
%  urA12clm  = tturA12clm';
%  urA11clm = uniqueclustermap_v002( rA11clm );
%  urA12clm = uniqueclustermap_v002( rA12clm );
  urA11clm = uniqueclustermap_v001( rA11clm );
  urA12clm = uniqueclustermap_v001( rA12clm );
  % Registration
  ...
  ccA11reg = registercl_v012( uC1clm,burA11clm, 0 );
  ccA12reg = registercl_v012( uC1clm,burA12clm, 0 );
...
%  parfor cntr=1:nBIGcl
  ...
  % Pipeline Output
%  cocoa = ClusterRA11';   % ClusterRA11' (:) = reshape( ClusterRA11.', 1,[] )
%  cacao = ClusterRA12';   % ClusterRA12' (:) = reshape( ClusterRA12.', 1,[] )
%  cocoa = cocoa(mtchS1);
%  cacao = cacao(mtchS2);
  cocoa = ClusterRA11(mtchS1);
  cacao = ClusterRA12(mtchS2);
